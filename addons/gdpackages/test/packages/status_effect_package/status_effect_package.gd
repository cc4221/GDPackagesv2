...
## StatusEffectPackage - Управление статус-эффектами
## Freeze: 4 сек, блокирует атаку и лечение
## Poison: 5 сек, наносит 1 HP в секунду (не убивает)
## Эффекты НЕ являются состояниями FSM
